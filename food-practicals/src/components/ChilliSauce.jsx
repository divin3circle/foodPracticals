...
const ChilliSauce = () => {
  ...
  return (
    /* console.log(data) */
    <div id="#chilly">
      <div className="max-w-[1640px] my-8 mx-auto p-4 hover:opacity-95 hover:scale-95 duration-150 cursor-pointer ease-in-out " data-aos="flip-right" data-aos-duration="2000" data-aos-easing='ease-out-cubic' >
